...
import (
	...
	//"encoding/json"
	//"fmt"
	"github.com/behzadmousavi/goFirst/internal"
...
func main() {
	...
	e.GET("/add", internal.AddNumber)
	e.GET("/deduct", internal.SubtractNumber)
	e.GET("/multiply", internal.MultiplyNumber)
	e.GET("/divide", internal.DivideNumber)
	e.POST("/math", internal.MathFunc)
